...
enum class ObjectType { Floor, Platform, Special, RoomBounds, Turret, Block, Rope, Water, BreakableWall, Staircase, Spike, Elevator };
...
public:
    ...
    gsl::czstring GetName() const override { return "LevelEditor"; }

    static void SetGameObjects(CS230::GameObjectManager* gom) { s_gom = gom; }
    static void SetSpawnPos(Math::vec2 pos)                  { s_spawnPos = pos; }
...
private:
    enum class EditorMode { View, Rect, Polygon, VertexEdit };
    ...
    void DrawDashedLine(CS200::IRenderer2D& r,
