...
void Mode1::Load()
{
    ...
    mapManager->SetGameObjectFactory([this](GameObjectTypes /*type*/, Math::vec2 pos, const std::string& color, const std::string& id) -> CS230::GameObject* {
    ...
    backgroundShader = OpenGL::CreateShader(
        std::filesystem::path("Assets/shaders/Cradle.vart"), 
        std::filesystem::path("Assets/shaders/Cradle.frag")
    );
