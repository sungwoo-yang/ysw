...
if(WIN32)
    ...
    set(SDL2_INC_DIR "${sdl2_mixer_SOURCE_DIR}/include")
    if(NOT EXISTS "${SDL2_INC_DIR}/SDL2")
        file(MAKE_DIRECTORY "${SDL2_INC_DIR}/SDL2")
        file(COPY "${SDL2_INC_DIR}/SDL_mixer.h" DESTINATION "${SDL2_INC_DIR}/SDL2")
    endif()
